...
import com.example.myfristbutton.databinding.ActivityImpactedRegionBinding;
...
public class ImpactedRegionActivity extends AppCompatActivity implements OnMapReadyCallback {

    private AppBarConfiguration appBarConfiguration;
    private ActivityImpactedRegionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_impacted_region);

        textViewToronto = findViewById(R.id.textView1);

        // TODO: find the place. maybe a new page or in current page to display the impacted region
        ...
        Button impactedPolygonButton = findViewById(R.id.button_impacted_polygon);
        impactedPolygonButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mMap != null)
                {
                    ...
                    boolean isIn = isInsidePolygon(latLngList, toronto_coordinate);

                    // TODO: display false in text meaning Toronto/destination city is not in the polygon
                    textViewToronto.setText(isIn+"");
     ...
     private class DownloadWebpageTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... urls) {
            try {
                ...
                System.out.println("!!!! latLngList 222: " + latLngList);
